    ...
    guidance: {
      instructions: [
        ...
        },
        {
          ...
          point: { latitude: 34.0530, longitude: -118.2450 },
        ...
        },
        {
          ...
          travelTimeInSeconds: 720,
          point: { latitude: 34.0540, longitude: -118.2460 },
...
describe('calculateRoute', () => {
  ...
  it('parses TomTom response into RouteResponse format', async () => {
    ...
    const result = await calculateRoute(34.0522, -118.2437, 34.0540, -118.2460, 'test-key')
    ...
    expect(result.coordinates[3]).toEqual([-118.2460, 34.0540])
  ...
  it('throws on API error', async () => {
    ...
    await expect(calculateRoute(34.05, -118.24, 34.06, -118.25, 'bad-key'))
  ...
  it('throws when no routes returned', async () => {
    ...
    await expect(calculateRoute(34.05, -118.24, 34.06, -118.25, 'key'))
