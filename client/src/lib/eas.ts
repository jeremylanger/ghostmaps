...
import { Interface, keccak256, toUtf8Bytes, getBytes, concat } from 'ethers'
...
export const REVIEW_SCHEMA_UID = '0x968e91f0274b78a31037839b55e59b942dd1521daebf9190268137e450b7d69f'
...
export function encodeReviewData(review: ReviewData): string {
  ...
  return encoder.encodeData([
    ...
    { name: 'photoHash', value: review.photoHash || ZERO_BYTES32, type: 'bytes32' },
...
export function buildAttestCalldata(schemaUID: string, encodedData: string): string {
